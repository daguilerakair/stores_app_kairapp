<div>
    ...
    @else
        <p class="font-semibold text-black text-xl text-center">No hay colaboradores que formen parte de la tienda</p>
    @endif
</div>
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            @this.on('deleteUser', (user) => {
                console.log('select')
                Swal.fire({
                    title: '¿Estás seguro que quieres eliminar este colaborador?',
                    icon: 'warning',
