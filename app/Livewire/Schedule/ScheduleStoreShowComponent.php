...
class ScheduleStoreShowComponent extends Component
{
    ...
    public $days = [
        'Lu' => ['name' => 'Lunes', 'position' => 1],
        'Ma' => ['name' => 'Martes', 'position' => 2],
        'Mie' => ['name' => 'Miércoles', 'position' => 3],
        'Ju' => ['name' => 'Jueves', 'position' => 4],
        'Vi' => ['name' => 'Viernes', 'position' => 5],
        'Sa' => ['name' => 'Sábado', 'position' => 6],
        'Do' => ['name' => 'Domingo', 'position' => 7],
    ];
    ...
    public function save()
    {
        ...
        if ($response) {
            ...
            // Format the schedule
            $schedulesSubstore = $this->formatSchedule($this->selectedSubStore->id);
